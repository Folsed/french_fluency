...
const UsableButtons: React.FC<ICheckout> = ({
    ...
    return (
        <div className='flex flex-col gap-2 md:flex-row md:gap-2'>
            <button
                className='group relative z-0 h-[60px] w-full overflow-hidden bg-font-secondary text-xl font-bold text-black shadow-custom duration-300'
                onClick={paymentModalHandler}
            >
                <div className='absolute left-[-100%] top-0 z-0 h-[150px] w-full rounded-[50%] bg-white duration-300 group-hover:translate-x-[100%] group-hover:translate-y-[-50%] group-hover:rounded-none' />
